...
resource "aws_ami_from_instance" "roboshop-dev-catalogue" {
...
resource "null_resource" "delete_instance" {
    ...
    depends_on = [ aws_ami_from_instance.roboshop-dev-catalogue ]
...
resource "aws_launch_template" "catalogue" {
  ...
  image_id = aws_ami_from_instance.roboshop-dev-catalogue.id
